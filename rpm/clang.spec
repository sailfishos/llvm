...
Patch0:	0001-ToolChain-Add-lgcc_s-to-the-linker-flags-when-using-.patch
Patch1:	0001-Make-funwind-tables-the-default-for-all-archs.patch
Patch2:	clang-sailfishos-toolchain.patch
